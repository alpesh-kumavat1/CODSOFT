...
void Play_game(char nums[][3] , char &character , string &s1 , string &s2){
    ...
    if(character == 'x'){
        cout<<"\n\t\t"<<s1<<" enter your positon : ";
        cin>>position;
        
    }
    if(character == '0'){
        cout<<"\n\t\t"<<s2<<" enter your positon : ";
        cin>>position;
    ...
    if(position == 1){
        ...
        cout<<"\n\t\tInvalid Position..Enter Valid Position"<<endl;
    }
...
bool check_winner(char nums[][3] , bool &tie){
    ...
    if((nums[0][0] == nums[1][1] && nums[1][1] == nums[2][2]) || (nums[0][2] == nums[1][1] && nums[1][1] == nums[2][0])){
        return true;
    }
...
void Display(char matrix[][3] , bool &tie , string &s1 , string &s2 , char &character){
    ...
    if(character == 'x' && tie == false){
        cout<<"\n\t\t"<<"Hey !! "<<s2<<" Congratulations...!!!"<<"\n\t\t\t You Win....!!";
    }
    else if(character == '0' && tie == false){
        cout<<"\n\t\t"<<"Hey !! "<<s1<<" Congratulations...!!!"<<"\n\t\t\t You Win....!!";
    }
    else{
        cout<<"\n\t\t"<<"Its a Draw";
    }
